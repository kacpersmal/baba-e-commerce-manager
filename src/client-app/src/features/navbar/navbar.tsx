                ...
                <NavigationMenu className="w-full">
                    <NavigationMenuList className="px-0 flex gap-2">
                        ...
                        <NavigationMenuItem>
                            ...
                            <NavigationMenuContent className="bg-white shadow-xl p-6 rounded-md min-w-[1000px] flex gap-6 items-start">
                        ...
                        ${activeCategory.title === cat.title
                                ...
                                {/* Prawa kolumna */}
                                <div
                                    className={`w-2/3 pl-4 overflow-y-auto max-h-[472px] transition-opacity duration-150 ${fade ? "opacity-0" : "opacity-100"
                                        }`}
                                >
